...
parser.add_argument('--steps', type=int, default=90)
    parser.add_argument('--coupling_min', type=float, default=0.1)
    parser.add_argument('--coupling_max', type=float, default=1.0)
    return parser.parse_args()

def main():
    args = parse_args()
    os.makedirs(args.output, exist_ok=True)
    print("CLIO level coupling scan:", vars(args))
