...
parser.add_argument('--steps', type=int, default=80)
    parser.add_argument('--intervention_time', type=int, default=40)
    parser.add_argument('--intervention_strength', type=float, default=0.5)
    return parser.parse_args()

def main():
    args = parse_args()
    os.makedirs(args.output, exist_ok=True)
    print("EMS policy intervention:", vars(args))
